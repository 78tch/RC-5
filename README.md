...
4. バッキングトラックを１回だけ再生して停止する（録音しない）：「LOOP」の1SHOT をONに
5. バッキングトラックに使える音声ファイル形式：WAV（44.1kHz、ステレオ32ビット浮動小数点）、１トラック最大約1.5時間、メモリー合計最大約13時間
6. 録音する小節数を指定：「LOOP」のMEASURE を1MEAS～99MEASに
